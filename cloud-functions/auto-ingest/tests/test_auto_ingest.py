...
Run from the repo root with: uv run --extra cloud-functions python \
cloud-functions/auto-ingest/tests/test_auto_ingest.py
"""
...
def test_imports() -> bool:
    ...
    try:
        ...
        rag.TransformationConfig(rag.ChunkingConfig(chunk_size=512, chunk_overlap=100))
...
def test_cloud_event_handling() -> bool:
...
def test_rag_client_initialization() -> bool:
    ...
    try:
        ...
        assert (
            client1.corpus_resource_name == expected1
        ), f"Expected {expected1}, got {client1.corpus_resource_name}"
        ...
        assert (
            client2.corpus_resource_name == full_name
        ), f"Expected {full_name}, got {client2.corpus_resource_name}"
        ...
        assert (
            client3.corpus_resource_name == expected3
        ), f"Expected {expected3}, got {client3.corpus_resource_name}"
